...
const TOUR_STEPS: TourStep[] = [
    {
        ...
        description: 'Profile your data locally — nothing ever leaves your device. Fast, private, and secure.',
    },
    {
        icon: '📁',
        title: 'Import Your Data',
        description: 'Drag and drop files or click to browse. We support CSV, JSON, Excel, Parquet, and Avro.',
    },
    {
        icon: '☁️',
        title: 'Remote Sources',
        description: 'Connect to Google Cloud Storage or databases like PostgreSQL to profile data directly.',
    },
    {
        icon: '📊',
        title: 'Explore Results',
        description: 'Get statistics, quality scores, histograms, and export to JSON Schema, Great Expectations, and more.',
    },
    {
        icon: '🚀',
        title: "You're Ready!",
        description: 'Try our sample dataset to see DataCert in action, or import your own files to get started.',
    },
];
            ...
            >
                ...
                >
                    ...
                    <div class="pt-16 pb-8 px-8 text-center">
                        {/* Icon */}
                        <div class="text-6xl mb-6 animate-in zoom-in duration-300">
                            {step().icon}
                        </div>
                        ...
                        {/* Description */}
                        <p class="text-slate-400 leading-relaxed mb-8 max-w-sm mx-auto">
                            {step().description}
                        </p>
                            ...
                            <For each={TOUR_STEPS}>
                                {(_, index) => (
                                    <button
                                        ...
                                        class={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${index() === currentStep()
