        ...
        `}
          ...
          `}>
                    ...
                    <div class="flex items-center justify-center gap-3">
                        <span class="px-2 py-1 rounded-md bg-slate-800 text-[10px] font-bold text-slate-500 border border-slate-700">.YML</span>
                        <span class="px-2 py-1 rounded-md bg-slate-800 text-[10px] font-bold text-slate-500 border border-slate-700">.YAML</span>
                        <span class="px-2 py-1 rounded-md bg-slate-800 text-[10px] font-bold text-slate-500 border border-slate-700">.JSON</span>
                    </div>
                </div>
