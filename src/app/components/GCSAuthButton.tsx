    ...
    <div class="flex items-center justify-center">
      <Show
        ...
        fallback={
          <button
            onClick={login}
            class="flex items-center gap-2 px-4 py-2 bg-white text-slate-700 rounded-lg font-medium shadow-sm hover:bg-gray-50 transition-colors border border-slate-300"
          >
