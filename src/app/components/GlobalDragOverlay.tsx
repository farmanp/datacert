...
export const GlobalDragOverlay: Component = () => {
  ...
  return (
    <Show when={store.state === 'hover'}>
      <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-blue-600/20 backdrop-blur-md animate-in fade-in zoom-in duration-300 pointer-events-none">
        {/* Animated Background Pulse */}
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
          <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-pulse" />
          <div class="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-pulse" />
          <div class="absolute inset-y-0 left-0 w-1 bg-gradient-to-b from-transparent via-blue-400 to-transparent animate-pulse" />
          <div class="absolute inset-y-0 right-0 w-1 bg-gradient-to-b from-transparent via-blue-400 to-transparent animate-pulse" />
        </div>
        ...
        <div class="relative bg-slate-900/90 border-2 border-blue-500/50 rounded-[40px] p-16 shadow-2xl flex flex-col items-center text-center max-w-2xl transform scale-110">
          ...
          <h2 class="text-5xl font-black text-white mb-4 tracking-tighter">Drop to Profile</h2>
