...
**User Story:**
As a developer
I want to export my DataLens profile as a JSON Schema
...
- Must correctly map DataLens types to JSON Schema types
...
- [ ] All DataLens types correctly mapped
...
| DataLens Type | JSON Schema Type | Additional Constraints |
|---------------|------------------|------------------------|
...
```json
{
  ...
  "$id": "datalens-generated-schema",
  "title": "data.csv",
  "description": "Schema generated by DataLens Profiler",
  "type": "object",
  "properties": {
    "id": {
      "type": "integer",
